    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <p class="mb-4">Muốn mua hàng thì bấm vào giỏ hàng bạn nhé!</p>
                <div class="d-flex mb-3">
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-2">
                        ...
                        <p>Được sản xuất bởi SE17B02 Group 2</p>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="media mb-4">
                                    ...
                                    <div class="media-body">
                                        <h6>John Kiên<small> - <i>01 Jan 2021</i></small></h6>
